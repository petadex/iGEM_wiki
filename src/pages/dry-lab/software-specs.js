...
const Page = () => (
  <WikiLayout pageTitle="Software Specs">
    <Placeholder><p>Content for <strong>Software Specs</strong> goes here.</p></Placeholder>
  </WikiLayout>
)
export default Page
export const Head = () => <title>Software Specs — iGEM Toronto 2026</title>
