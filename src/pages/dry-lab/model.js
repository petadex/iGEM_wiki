...
const Page = () => (
  <WikiLayout pageTitle="Generalized Model">
    <Placeholder><p>Content for <strong>Generalized Model</strong> goes here.</p></Placeholder>
  </WikiLayout>
)
export default Page
export const Head = () => <title>Generalized Model — iGEM Toronto 2026</title>
