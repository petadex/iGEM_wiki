...
const Page = () => (
  <WikiLayout pageTitle="Education Toolkit">
    <Placeholder><p>Content for <strong>Education Toolkit</strong> goes here.</p></Placeholder>
  </WikiLayout>
)
export default Page
export const Head = () => <title>Education Toolkit — iGEM Toronto 2026</title>
