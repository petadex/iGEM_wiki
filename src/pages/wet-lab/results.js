...
const Page = () => (
  <WikiLayout pageTitle="Results">
    <Placeholder><p>Content for <strong>Results</strong> goes here.</p></Placeholder>
  </WikiLayout>
)
export default Page
export const Head = () => <title>Results — iGEM Toronto 2026</title>
