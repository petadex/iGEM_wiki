...
const Page = () => (
  <WikiLayout pageTitle="Notebook">
    <Placeholder><p>Content for <strong>Notebook</strong> goes here.</p></Placeholder>
  </WikiLayout>
)
export default Page
export const Head = () => <title>Notebook — iGEM Toronto 2026</title>
