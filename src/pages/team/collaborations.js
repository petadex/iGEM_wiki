...
const Page = () => (
  <WikiLayout pageTitle="Collaborations">
    <Placeholder><p>Content for <strong>Collaborations</strong> goes here.</p></Placeholder>
  </WikiLayout>
)
export default Page
export const Head = () => <title>Collaborations — iGEM Toronto 2026</title>
