...
const Page = () => (
  <WikiLayout pageTitle="Hardware Notebook">
    <Placeholder><p>Content for <strong>Hardware Notebook</strong> goes here.</p></Placeholder>
  </WikiLayout>
)
export default Page
export const Head = () => <title>Hardware Notebook — iGEM Toronto 2026</title>
