...
const Page = () => (
  <WikiLayout pageTitle="Hardware Results">
    <Placeholder><p>Content for <strong>Hardware Results</strong> goes here.</p></Placeholder>
  </WikiLayout>
)
export default Page
export const Head = () => <title>Hardware Results — iGEM Toronto 2026</title>
